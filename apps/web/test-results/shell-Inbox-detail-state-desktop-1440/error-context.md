...
- Name: shell.spec.ts >> Inbox >> detail state
- Location: tests\vr\shell.spec.ts:105:7
...
waiting for navigation to "**/dashboard" until "load"
  navigated to "http://localhost:3000/login?organizationSlug=&email=vr%40vr-tenant.demo&password=Demo1234%21"
============================================================
```
