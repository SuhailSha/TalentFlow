...
- Name: dashboard.spec.ts >> Dashboard >> kpi strip only (crop)
- Location: tests\vr\dashboard.spec.ts:23:7
...
waiting for navigation to "**/dashboard" until "load"
  navigated to "http://localhost:3000/login?organizationSlug=&email=&password="
============================================================
```
