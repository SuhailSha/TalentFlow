...
- Name: shell.spec.ts >> Sidebar >> collapsed sidebar (light)
- Location: tests\vr\shell.spec.ts:21:7
...
waiting for navigation to "**/dashboard" until "load"
  navigated to "http://localhost:3000/login?organizationSlug=vr-tenant&email=vr%40vr-tenant.demo&password=Demo1234%21"
============================================================
```
